...
export const About = () => (
  <Container>
    ...
    <Description>
      ...
      disponibiliza com relação às barragens brasileiras, de fácil acesso e com
    ...
    <Description>
      ...
      , e não são apenas informações sobre barragens de minério e sim de vários
      propósitos, atualmente são mais de 3500 barragens cadastradas no{' '}
